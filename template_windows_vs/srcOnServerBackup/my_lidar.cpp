...
int func(int argc, char* argv[]) {
    ...
    auto ground_body = patch->GetGroundBody();      // ground_body: ChBody �ǵ��ε�ChBody

    auto vis_mat1 = chrono_types::make_shared<ChVisualMaterial>();
    vis_mat1->SetKdTexture(vehicle::GetDataFile("terrain/textures/grass.jpg"));         // Kd, Ks, Ke��һЩ���ʵķ��䡢������趨��
    vis_mat1->SetWeightTexture(GetChronoDataFile("sensor/textures/weight1.png"));       // ���ֵ��β��ϵĻ��Ȩ�ء�weight1��2�ǻ����ġ�
    ...
    visual_shape->SetMaterial(0, vis_mat1);         // ����i��material����Ϊĳ���ض���material
    ...
    vlp16->PushFilter(chrono_types::make_shared<ChFilterSavePtCloud>("C:/Users/larrydong/Desktop/lidar_output/"));  // �������filter����ÿ��Apply��Ӧ��filterʱ(update��)����ִ�б��浽�ļ��������Beam count
