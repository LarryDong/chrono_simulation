...
function generateJson(outputPath, params,a)
    ...
    % 动态生成文件名
    fileName = sprintf('force-A%dF%dV2-2024.12.23.json', a, params.IMU_force_freq);
...
outputPath = 'D:\lab\项目\振动对slam影响\matlab\json\json_output\accY_2024.12.23\AccY_test_12.23'; 
