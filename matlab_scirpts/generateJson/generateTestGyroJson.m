...
function generateJson(outputPath, params)
    ...
    % 动态生成文件名
    fileName = sprintf('torque-A%.1fF%dfV2-2024.12.23.json', params.IMU_torque_amp, params.IMU_torque_freq);
...
outputPath = 'D:\lab\项目\振动对slam影响\matlab\json\json_output\gyro_2024.12.23\gyroZ_differentG_F100'; 
...
params.IMU_torque_freq = 100;

for a = 0:2:700   
    params.IMU_torque_amp = a;    
